...
import static com.rkboss.mtk.constant.QRIMAGE;
...
public class deposit_money extends AppCompatActivity {
        ...
        ImageView qrcode;
        String check;
        Button btn500,btn1000,btn2000,btn5000,btn10000,btn20000;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            btn20000.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    amount.setText("");
...
//                }
        ...
        private void upiimg() {
            ...
            final StringRequest postRequest = new StringRequest(Request.Method.POST, url4,
                    new Response.Listener<String>() {
                        @Override
                        public void onResponse(String response) {
...
//                                String upi = jsonObject1.getString("upi_id");
//                                upiid.setText(upi);


                                String qrimg = jsonObject1.getString("qr_image");
                                Log.d("qrimg",""+qrimg);
                                Picasso.get().load(QRIMAGE+ qrimg).into(qrcode);
                                Log.d("qrimg1",""+Picasso.get().load(QRIMAGE+ qrimg));
