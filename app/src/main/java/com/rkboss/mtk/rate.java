...
import static com.rkboss.mtk.R.layout.activity_rate;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            doublegame.setText(jsonObject1.getString("jodi"));
                            ...
                            halfsangam.setText(jsonObject1.getString("halfsangam"));
                            fullsangam.setText(jsonObject1.getString("fullsangam"));
