...
class adapterplayed extends RecyclerView.Adapter<adapterplayed.ViewHolder> {
    ...
    public adapterplayed(Context context,ArrayList<String> date,ArrayList<String> bazar,ArrayList<String> amount,ArrayList<String> bet,ArrayList<String> gametype) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        holder.gamename.setText(gametype.get(position));
