...
import static com.rkboss.mtk.R.layout.activity_withdraw;
...
public class withdraw extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mobno = getSharedPreferences(constant.prefs, MODE_PRIVATE).getString("mobile", null);
...
// Set range filter
        ...
        findViewById(R.id.submit).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                } else if (Integer.parseInt(amount.getText().toString()) <= Integer.parseInt(getSharedPreferences(constant.prefs, Context.MODE_PRIVATE).getString("min_withdraw", String.valueOf(constant.min_deposit)))) {
...
//                    }
                    ...
                    // Get the mobile number from shared preferences (make sure you have saved it before)
                    String mobno = getSharedPreferences(constant.prefs, MODE_PRIVATE).getString("mobile", "");

                    // Prepare the message to be sent on WhatsApp
                    String message = "I want to withdraw money =>\nAmount - " + amt + "\nMobile Number  : "+mobno;

                    // Replace "YOUR_PHONE_NUMBER" with the actual phone number you want to send the message to
                    String phone = constant.getWhatsapp(getApplicationContext());;
                    ...
                    try {
                        // Start the WhatsApp activity with the pre-populated message
                        startActivity(sendIntent);
                    } catch (ActivityNotFoundException ex) {
                        // Handle case where WhatsApp is not installed on the device
                        // You can display a message to the user or take an appropriate action
                    }
