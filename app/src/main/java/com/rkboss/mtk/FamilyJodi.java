...
//        });
        ...
        if (!game.equals("jodi") && !getIntent().hasExtra("timing")){
            ...
            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(FamilyJodi.this, R.layout.simple_list_item_2, typeof);
        ...
        open_game.setOnClickListener(v -> {
            ...
            if (!open_av.equals("1")){
                ...
                fillamount.clear();
                fillmarket.clear();
                AdapterSingleGames rc = new AdapterSingleGames(FamilyJodi.this,fillnumber,fillamount,fillmarket);
                recyclerview.setLayoutManager(new GridLayoutManager(FamilyJodi.this, 1));
...
//                    game = TextUtils.join(",", fillgame);
                    AlertDialog.Builder builder1 = new AlertDialog.Builder(FamilyJodi.this);
...
//                }
    ...
    private void apicall() {
        ...
        progressDialog = new ViewDialog(FamilyJodi.this);
                ...
                response1 -> {
                    ...
                    try {
                        ...
                        if (jsonObject1.getString("active").equals("0")) {
                            Toast.makeText(FamilyJodi.this, "Your account temporarily disabled by admin", Toast.LENGTH_SHORT).show();
                        ...
                        if (!jsonObject1.getString("session").equals(getSharedPreferences(constant.prefs, MODE_PRIVATE).getString("session", null))) {
                            Toast.makeText(FamilyJodi.this, "Session expired ! Please login again", Toast.LENGTH_SHORT).show();
...
//                            showDialog2();
                ...
                error -> {
                    ...
                    progressDialog.hideDialog();
                    Toast.makeText(FamilyJodi.this, "Check your internet connection", Toast.LENGTH_SHORT).show();
                }
        ) {
            @Override
    ...
    public void getCycles(){
        ...
        cycles.put("12",new ArrayList<String>(Arrays.asList("12, 17, 21, 26, 62, 67, 71, 76".split(", "))));
        cycles.put("13",new ArrayList<String>(Arrays.asList("13, 18, 31, 36, 63, 68, 81, 86".split(", "))));
        cycles.put("14",new ArrayList<String>(Arrays.asList("14, 19, 41, 46, 64, 69, 91, 96".split(", "))));
        cycles.put("15",new ArrayList<String>(Arrays.asList("01, 06, 10, 15, 51, 56, 60, 65".split(", "))));
        cycles.put("23",new ArrayList<String>(Arrays.asList("23, 28, 32, 37, 73, 78, 82, 87".split(", "))));
        cycles.put("24",new ArrayList<String>(Arrays.asList("24, 29, 42, 47, 74, 79, 92, 97".split(", "))));
        cycles.put("25",new ArrayList<String>(Arrays.asList("02, 07, 20, 25, 52, 57, 70, 75".split(", "))));
        cycles.put("34",new ArrayList<String>(Arrays.asList("34, 39, 43, 48, 84, 89, 93, 98".split(", "))));
        cycles.put("35",new ArrayList<String>(Arrays.asList("03, 08, 30, 35, 53, 58, 80, 85".split(", "))));
        cycles.put("45",new ArrayList<String>(Arrays.asList("04, 90, 40, 45, 54, 59, 90, 95".split(", "))));
...
//        payLayout = findViewById(R.id.pay);
    ...
    public void showDialogBalance(){
        ...
        alertDialog1.show(FamilyJodi.this.getSupportFragmentManager(),"BalanceDialog");

    }

    public void showDialogBet(){
        BidPlaceDialog alertDialog = new BidPlaceDialog();
        alertDialog.show(FamilyJodi.this.getSupportFragmentManager(),"BidPlaceDialog");

    }

    public void showDialog2(){
        FragmentDialogBox2 alertDialog = new FragmentDialogBox2();
        alertDialog.show(FamilyJodi.this.getSupportFragmentManager(),"FragmentDialogBox2");
