...
//                                showDialog2();
    ...
    public void showDialogBalance(){
        ...
        alertDialog1.show(fullsangam.this.getSupportFragmentManager(),"BalanceDialog");

    }

    public void showDialogBet(){
        BidPlaceDialog alertDialog = new BidPlaceDialog();
        alertDialog.show(fullsangam.this.getSupportFragmentManager(),"BidPlaceDialog");

    }

    public void showDialog2(){
        FragmentDialogBox2 alertDialog = new FragmentDialogBox2();
        alertDialog.show(fullsangam.this.getSupportFragmentManager(),"FragmentDialogBox2");
