...
public class halfsangam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        totalamount.setFilters(filters);
...
// Set range filter
        ...
        totalamount.setFilters(new InputFilter[] { rangeFilter });
...
//                                showDialog2();
            ...
            protected Map<String, String> getParams() {
                ...
                Log.d("totalll",""+totalamount.getText().toString());
    ...
    private void initView() {
        ...
        firstitle =  findViewById(R.id.firstitle);
    ...
    public void showDialogBalance(){
        ...
        alertDialog1.show(halfsangam.this.getSupportFragmentManager(),"BalanceDialog");

    }

    public void showDialogBet(){
        BidPlaceDialog alertDialog = new BidPlaceDialog();
        alertDialog.show(halfsangam.this.getSupportFragmentManager(),"BidPlaceDialog");

    }

    public void showDialog2(){
        FragmentDialogBox2 alertDialog = new FragmentDialogBox2();
        alertDialog.show(halfsangam.this.getSupportFragmentManager(),"FragmentDialogBox2");
